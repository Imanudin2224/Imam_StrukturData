# Inisialisasi data awal menggunakan struktur nested list sesuai ketentuan
data_mahasiswa = [
    ["Ahmad", 85],
    ["Budi", 78],
    ["Citra", 90]
...
while True:
    ...
    # MENU 6: Urutkan Data Berdasarkan Nilai Tertinggi
        ...
        if not data_mahasiswa:
            ...
            # Menggunakan fungsi lambda untuk mengurutkan berdasarkan indeks ke-1 (Nilai) secara descending (tertinggi ke terendah)
    ...
    # Validasi jika user memasukkan input selain angka 1-8
    else:
